...
const Angxios = new (class {
  ...
  post(url, data, config) {
    return axios.post(url, data ? data : null, config ? config : null);
  }
   ...
   */
  put(url, data, config) {
    return axios.put(url, data ? data : null, config ? config : null);
  }
  ...
  patch(url, data, config) {
    return axios.patch(url, data ? data : null, config ? config : null);
  }
})();
